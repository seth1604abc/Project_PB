  ...
  const datas = [
    {
      ...
      body_part: "手",
      detail:
        "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iure alias culpa repellat animi. Corrupti minima omnis quae quo quos debitis natus, id, sint error inventore assumenda tempore eveniet fuga eligendi.",
    },
    {
      id: 2,
      title: "臨時影片名稱2",
    ...
    <>
      ...
      <div className="member-container d-flex">
        ...
        <div className="member-course-content">
          <div className="member-course-bar mt-3 mx-4">
            <span>排序方式</span>
            <button>發佈時間</button>
          </div>
