...
function EventContent(){
    ...
    return(
      ...
      <div className="singleEvent_container">
        ...
        <div className="singleEvent_title h2 mx-5 my-3">
          科學增肌減脂-Dr.史考特來解惑
        </div>
        <div className="d-flex justify-content-between">
          <div className="d-flex align-items-center">
            <div className="singleEvent_coach ms-5"></div>
            <div className="h6 ms-2">Fiona</div>
          </div>
          <button
            className="
          ...
          <div className="singleEvent_eventContent_wrapper">
            <div className="ms-5 my-3">
              ...
              <p className="my-3">
                ...
                -擁有六塊肌，等於擁有健康？<br />
                -活得更久更健康，運動是萬靈丹<br />
                -總是肥在屁股和大腿！拆解女生梨形身材原因<br />
                -訓練拚命到筋疲力盡，比較有效嗎？<br />
                科學改善了人類生活的所有面向，飲食運動也不該例外。<br />
                此次特地邀請到長庚醫院復健科主治醫師史考特(王思恆) <br />
                與本站課程會員分享科學增肌減脂的最新觀念<br />
                健身不只是強健身體，健身更要強健大腦。
              </p>
            </div>
          </div>
            ...
            <div className="m-5">
              <div>
                <div className="row d-flex align-items-center">
                  ...
                  <span className="col-8 singleEvent_detail_title">活動時間</span>
                </div>
                <div className="row">
              ...
              <div className="mt-2">
                <div className="row">
                  ...
                  <span className="col-8 singleEvent_detail_title">活動地點</span>
                </div>
                <div className="row">
                  <div className="col-1"></div>
                  <span className="col-8"
                    >MRT文創古亭6號空間 台北市大安區羅斯福路二段33號12樓</span>
                </div>
              </div>
            </div>
        ...
        <h5 class="text-center my-5">活動地圖</h5>
        <div class="singleEvent_map_wrapper">
          <div class="singleEvent_img"></div>
          </div>
      </div>
    </div>
    )
