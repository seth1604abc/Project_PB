        ...
        <>
            ...
            <div className="RecommandProduct d-flex align-items-center mb-4 pe-5">
                ...
                <div>
                    ...
                    <p className="mb-2"><span className="RecommandProduct__part p-1 me-1"># {BODY_PARTS[part]}</span><span className="RecommandProduct__rating">4.5<i className="fas fa-star"></i></span></p>
                    <p>NT${price}</p>
                </div>
            </div>
                </Link>
